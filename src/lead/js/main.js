...
function startAds(prefix) {
	...
	/*copy1*/
	creative.dom.copy1Text.innerText = prefix.fonQ_dynamic_banners_9102017_Blad1[0].copy1;
	creative.dom.copy1.style.color = prefix.fonQ_dynamic_banners_9102017_Blad1[0].copy1_fontcolor;

	/*copy2*/
	creative.dom.copy2Text.innerText = prefix.fonQ_dynamic_banners_9102017_Blad1[0].copy2;
...
function animation() {
	...
	creative.dom.skylineBg.style.opacity = prefix.fonQ_dynamic_banners_9102017_Blad1[0].skyline_opacity;
	...
	.to(creative.dom.background, 0, {opacity: 1,ease:Sine.easeOut}, 6)
	.to(creative.dom.background, 1.5, {width: '100%', ease:Sine.easeOut},7)
	.to(creative.dom.cta, 0.5, {opacity: 1, ease:Sine.easeOut},8.5);
