...
function setupDom() {
	...
	creative.dom.ctaFooter = document.querySelector('#footerCTA');

	creative.dom.gradient = document.querySelector('#gradient');

	creative.dom.skyline = document.querySelector('#skyline');

	creative.dom.logoSmall = document.querySelector('#logo'); 
...
function startAds(prefix) {
	...
	/*Cta*/
	creative.dom.cta.innerText = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_text;
    ...
    /*Cta Footer*/
    creative.dom.ctaFooter.innerText = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_text;
	creative.dom.ctaFooter.style.color = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_text_color;
	creative.dom.ctaFooter.style.backgroundColor  = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bg_color;
	creative.dom.ctaFooter.style.borderColor  = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bordercolor
	creative.dom.ctaFooter.onmouseover  = function() {
       this.style.backgroundColor = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bg_hover_color;
       this.style.borderColor = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bordercolor_hover;
    }
    creative.dom.ctaFooter.onmouseout   = function() {
       this.style.backgroundColor = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bg_color;
       this.style.borderColor = prefix.fonQ_dynamic_banners_9102017_Blad1[0].cta_bordercolor;
    }
...
function animation() {
	...
	creative.dom.copy3_1.style.opacity = 0;
	creative.dom.copy3_2.style.opacity = 0;
	creative.dom.copy3_3.style.opacity = 0;
	creative.dom.background.style.opacity = 0;
	creative.dom.cta.style.opacity = 0;
	creative.dom.skyline.style.opacity = 0;
	...
	.to(creative.dom.rollOverImg, 0, {opacity: 0,ease:Sine.easeOut}, 6)
	.to(creative.dom.copy2, 0, {opacity: 0,ease:Sine.easeOut}, 6)
	.to(creative.dom.footer, 0, {opacity: 0,ease:Sine.easeOut}, 6)
	.to(creative.dom.gradient, 0, {opacity: 0,ease:Sine.easeOut}, 6)

	/*skyline from feed opacity*/
	...
	.to(creative.dom.background, 0, {opacity: 1,ease:Sine.easeOut}, 6)
	.to(creative.dom.copy3_1, 0, {opacity: 1,ease:Sine.easeOut}, 7)
	.to(creative.dom.copy3_2, 0, {opacity: 1,ease:Sine.easeOut}, 7.5)
	.to(creative.dom.copy3_3, 0, {opacity: 1,ease:Sine.easeOut}, 8)
	.to(creative.dom.cta, 0, {opacity: 1,ease:Sine.easeOut}, 8.5);
}
